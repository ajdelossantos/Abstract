...
comment6 = Comment.create({ body: "This is a test comment.", story_id: story3.id, author_id: 2})
comment7 = Comment.create({ body: "This is another test comment.", story_id: story3.id, author_id: 2})
comment8 = Comment.create({ body: "This is more testing comments.", story_id: story3.id, author_id: 2})
comment9 = Comment.create({ body: "Hello World.", story_id: story3.id, author_id: 2})
...
comment20 = Comment.create({ body: "This is a test comment reply.", story_id: story8.id, author_id: user0.id})