...
comment21 = Comment.create({ body: "This is a test comment.", story_id: story1.id, author_id: user3.id })
comment22 = Comment.create({ body: "This is a test comment.", story_id: story1.id, author_id: user3.id })
comment23 = Comment.create({ body: "This is a test comment.", story_id: story1.id, author_id: user3.id })
comment24 = Comment.create({ body: "This is a test comment.", story_id: story1.id, author_id: user3.id })
comment25 = Comment.create({ body: "This is a test comment.", story_id: story1.id, author_id: user3.id })
comment26 = Comment.create({ body: "This is a test comment.", story_id: story1.id, author_id: user3.id })
comment27 = Comment.create({ body: "This is a test comment.", story_id: story1.id, author_id: user3.id })
comment28 = Comment.create({ body: "This is a test comment.", story_id: story1.id, author_id: user3.id })
comment29 = Comment.create({ body: "This is a test comment.", story_id: story1.id, author_id: user3.id })
comment30 = Comment.create({ body: "This is a test comment.", story_id: story1.id, author_id: user3.id })